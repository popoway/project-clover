        ...
        <div class="col-12 col-lg-6 text-center">
          ...
          <div class="signin-avatar-picker">
            <div class="signin-avatar-picker-choice" tabindex="0">
              <img src="<?php echo PC_SITEURL; ?>/assets/img/authuser_0.jpg?ver=<?php echo PC_VER; ?>" title="Avatar of Yeshan" alt="Avatar of Yeshan" class="img-thumbnail rounded" width="72">
              <span>Yeshan</span>
            </div>
            <div class="signin-avatar-picker-choice" tabindex="0">
              <img src="<?php echo PC_SITEURL; ?>/assets/img/authuser_1.jpg?ver=<?php echo PC_VER; ?>" title="Avatar of Ming" alt="Avatar of Ming" class="img-thumbnail rounded" width="72">
              <span>Ming</span>
            </div>
          </div>
